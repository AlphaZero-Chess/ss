...
// From: Lichess Bot-AlphaZero-Final-elegant.user.js
// ═══════════════════════════════════════════════════════════════════════
const ELEGANT_CONFIG = {
  thinkingTimeMin: 150,
  thinkingTimeMax: 800,
  humanMistakeRate: 0,
  baseDepth: 18,
...
// Tactical monster, aggressive play, material hunter
// From: Lichess Bot-AlphaZero-Final-non-elegant.user.js
// ═══════════════════════════════════════════════════════════════════════
const NON_ELEGANT_CONFIG = {
  thinkingTimeMin: 150,
  thinkingTimeMax: 800,
  humanMistakeRate: 0,
  baseDepth: 18,
...
const NON_ELEGANT_OPENINGS = {
  ...
  "r1bqkbnr/pppp1ppp/2n5/4p3/2B1P3/5N2/PPPP1PPP/RNBQK2R b KQkq -": {
    black: [
      { move: "g8f6", weight: 0.45 },
      { move: "f8c5", weight: 0.40 },
      { move: "f8e7", weight: 0.15 }
    ]
  },
  "r1bqkb1r/pppp1ppp/2n2n2/4p3/2B1P3/5N2/PPPP1PPP/RNBQK2R w KQkq -": {
    white: [
      { move: "g1f3", weight: 0.40 },
      { move: "d2d3", weight: 0.30 },
      { move: "b2b4", weight: 0.20 },
      { move: "f3g5", weight: 0.10 }
    ]
  },
  "r1bqkbnr/pppp1ppp/2n5/1B2p3/4P3/5N2/PPPP1PPP/RNBQK2R b KQkq -": {
    black: [
  ...
  "rnbqkbnr/ppp2ppp/4p3/3p4/2PP4/8/PP2PPPP/RNBQKBNR w KQkq -": {
    white: [
      ...
      { move: "c4d5", weight: 0.20 }
    ]
  },
  "rnbqk2r/pppp1ppp/4pn2/8/1bPP4/2N5/PP2PPPP/R1BQKBNR w KQkq -": {
    white: [
      { move: "e2e3", weight: 0.40 },
      { move: "d1c2", weight: 0.35 },
      { move: "f1d3", weight: 0.15 },
  ...
  "rnbqkbnr/ppp2ppp/4p3/3pP3/3P4/8/PPP2PPP/RNBQKBNR b KQkq -": {
    black: [
      { move: "c7c5", weight: 0.60 },
      { move: "b8c6", weight: 0.25 },
      { move: "g8e7", weight: 0.15 }
    ]
  },
  "rnbqkbnr/pp1ppppp/2p5/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq -": {
    white: [
  ...
  "r1bqkbnr/pppp1ppp/2n5/4p3/3PP3/5N2/PPP2PPP/RNBQKB1R b KQkq d3": {
    black: [
      { move: "e5d4", weight: 0.70 },
      { move: "d7d6", weight: 0.20 },
      { move: "f8b4", weight: 0.10 }
    ]
  },
...
const MINI_A0_CONFIG = {
  ...
  openingDepth: 13,
  strategicDepth: 18,
  contempt: 24, // Balanced
  aggressionFactor: 0.45, // Strategic, not aggressive
  strategicDepthLevel: 95,
  positionalPatience: 90,
  endgamePrecision: 100,
  resilience: 95,
  grindingAbility: 90,
  openingSpeed: 0.25,
...
const MINI_A0_OPENINGS = {
  "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq -": {
    white: [
      { move: "e2e4", weight: 0.45 },
      { move: "d2d4", weight: 0.40 },
      { move: "c2c4", weight: 0.10 },
      { move: "g1f3", weight: 0.05 }
    ]
  },
  "rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3": {
    black: [
      { move: "c7c5", weight: 0.35 },
      { move: "e7e5", weight: 0.30 },
      { move: "e7e6", weight: 0.20 },
      { move: "c7c6", weight: 0.15 }
    ]
  },
  "rnbqkbnr/pppppppp/8/8/3P4/8/PPP1PPPP/RNBQKBNR b KQkq d3": {
    black: [
  ...
  "r1bqk1nr/pppp1ppp/2n5/2b1p3/2B1P3/5N2/PPPP1PPP/RNBQK2R w KQkq -": {
    white: [
      { move: "c2c3", weight: 0.45 },
      { move: "b2b4", weight: 0.35 },
      { move: "d2d3", weight: 0.20 }
    ]
  },
  "r1bqkbnr/pppp1ppp/2n5/1B2p3/4P3/5N2/PPPP1PPP/RNBQK2R b KQkq -": {
    black: [
      { move: "a7a6", weight: 0.45 },
  ...
  "rnbqkbnr/ppp1pppp/8/3P4/8/8/PPPP1PPP/RNBQKBNR b KQkq -": {
    black: [
      { move: "d8d5", weight: 0.50 },
      { move: "g8f6", weight: 0.50 }
    ]
  },
  "rnbqkbnr/pppp1ppp/4p3/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq -": {
    white: [
      { move: "d2d4", weight: 0.65 },
      { move: "d2d3", weight: 0.20 },
  ...
  "rnbqkbnr/ppp1pppp/8/3p4/3P4/8/PPP1PPPP/RNBQKBNR w KQkq d6": {
    white: [
      { move: "c1f4", weight: 0.40 },
      { move: "g1f3", weight: 0.35 },
      { move: "c2c4", weight: 0.25 }
    ]
  },
  "rnbqkb1r/pppppp1p/5np1/8/2PP4/8/PP2PPPP/RNBQKBNR w KQkq -": {
    white: [
